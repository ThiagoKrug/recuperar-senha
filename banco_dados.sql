...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24/06/2024 às 18:48
...
--
DROP DATABASE IF EXISTS `recuperar-senha`;
CREATE DATABASE IF NOT EXISTS `recuperar-senha` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `recuperar-senha`;
